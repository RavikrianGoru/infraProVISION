...
public class DataProcessor {
	...
	public Node collectData()
	{
		...
		List<Node> virtualNodes = processAsNodeList(virtualResponse, VIRTUAL_ID_KEY, VIRTUAL_PARENT_KEY, VIRTUAL_URL,
				VIRTUAL_STATUS_KEY);
		...
		List<Node> databaseNodes = processAsNodeList(databaseResponse, DATABASE_ID_KEY, DATABASE_PARENT_KEY,
