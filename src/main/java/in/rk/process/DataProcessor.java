...
public class DataProcessor {
	...
	private static final String DEP_TAG = "TAG";
	...
	public  static List<Node> processAsNodeList(List<Map<String, String>> response,String tag, String idKey, String nameKey,
	...
	public  static List<Node> createSingleNodeList(String tag, String id, String name, String url, String status,
			Map<String, String> data, List<Node> childs) {
		List<Node> nodeList = new ArrayList<>();
		Node node = Node.builder().tag(tag).id(id).name(name).url(url).status(status).data(data).childs(childs).build();
		nodeList.add(node);
		return nodeList;
	}
	...
	public static void main(String[] args) {
		...
		List<Node> appcodeNodes = processAsNodeList(appcodeResponse, APPCODE_TAG, APPCODE_ID_KEY, APPCODE_PARENT_KEY, APPCODE_URL,
				APPCODE_STATUS_KEY);
